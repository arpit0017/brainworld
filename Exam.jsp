...
// 	System.out.println(Username);
	...
	int UserTestId=Integer.parseInt(request.getAttribute("UserTestId").toString());
...
<div class="bg-GrayShine BorderGreen" style="min-height:65vh;min-width:80vw;overflow:shown;">
<%
	...
	out.println("<input type=\"hidden\" value=\""+UserTestId+"\" name=\"UserTestId\">");
